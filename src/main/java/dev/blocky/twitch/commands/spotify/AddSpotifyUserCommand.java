...
public class AddSpotifyUserCommand implements ICommand
{
    ...
    public void onCommand(@NonNull ChannelMessageEvent event, @NonNull TwitchClient client, @NonNull String[] prefixedMessageParts, @NonNull String[] messageParts) throws Exception
    {
        ...
        {
            chat.sendMessage(channelName, "FeelsMan Please specify the Spotify authorization code that was generated by https://apujar.blockyjar.dev/oauth2/spotify.html FeelsOkayMan");
            return;
        }
        ...
        {
            chat.sendMessage(channelName, "FeelsDankMan Invalid authorization code specified. (Authorization code must start with 'AQ' and contain 376 case insensitive letters with underscores [_], minuses [-] and numbers)");
            return;
        }
        ...
        chat.sendMessage(channelName, "SeemsGood Successfully updated Spotify credential in the database.");
    }
}
