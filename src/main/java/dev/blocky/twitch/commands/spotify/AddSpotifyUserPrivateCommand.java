...
public class AddSpotifyUserPrivateCommand implements IPrivateCommand
{
    ...
    public void onPrivateCommand(@NonNull PrivateMessageEvent event, @NonNull TwitchHelix helix, @NonNull String[] messageParts) throws Exception
    {
        ...
        {
            sendPrivateMessage(helix, eventUserID, "FeelsMan Please specify the Spotify authorization code that was generated by https://apujar.blockyjar.dev/oauth2/spotify.html FeelsOkayMan");
            return;
        }
        ...
        {
            sendPrivateMessage(helix, eventUserID, "FeelsDankMan Invalid authorization code specified. (Authorization code must start with 'AQ' and contain 376 case insensitive letters with underscores [_], minuses [-] and numbers)");
            return;
        }
        ...
        if (!spotifyUserIIDs.contains(eventUserIID))
        {
            ...
            sendPrivateMessage(helix, eventUserID, "SeemsGood Successfully added Spotify credentials.");
            return;
        }
        ...
        sendPrivateMessage(helix, eventUserID, "SeemsGood Successfully updated Spotify credential in the database.");
    }
}
