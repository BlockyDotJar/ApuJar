...
public class IsPartnerCommand implements ICommand
{
    ...
    public boolean onCommand(@NonNull ChannelChatMessageEvent event, @NonNull TwitchClient client, @NonNull String[] prefixedMessageParts, @NonNull String[] messageParts) throws Exception
    {
        ...
        {
            return sendChatMessage(channelID, STR."Sadge \{ivrUserDisplayName} isn't a Twitch partner at the moment.");
        }

        channelID = getActualChannelID(channelToSend, channelID);

        return sendChatMessage(channelID, STR."DinoDance \{ivrUserDisplayName} is a Twitch partner POGGERS");
    }
}
