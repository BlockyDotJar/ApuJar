...
public class IsBannedCommand implements ICommand
{
    ...
    public boolean onCommand(@NonNull ChannelChatMessageEvent event, @NonNull TwitchClient client, @NonNull String[] prefixedMessageParts, @NonNull String[] messageParts) throws Exception
    {
        ...
        if (!ivrUser.isBanned())
        {
            return sendChatMessage(channelID, STR."Saved \{userDisplayName} isn't banned from Twitch at the moment.");
        }
        ...
        return sendChatMessage(channelID, STR."monakS \{userDisplayName} is banned from Twitch \u26D4 (Reason: \{userBanReason}) \u26D4");
    }
}
