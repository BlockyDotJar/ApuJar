...
public class Command
{
    ...
    @NonNull
    public ICommand getCommandAsClass() throws Exception
    {
        Class<?> commandClass = Class.forName(STR."dev.blocky.twitch.commands.\{clazz}Command");
        Constructor<?> commandConstructor = commandClass.getDeclaredConstructor();
        return (ICommand) commandConstructor.newInstance();
    }
